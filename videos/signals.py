...
def start_hls_conversion(sender, instance, created, **kwargs):
    """Enqueue HLS conversion and thumbnail generation when a new video is uploaded."""
    if created:
...
def handle_missing_thumbnail(sender, instance, created, **kwargs):
    """Enqueue thumbnail regeneration when an existing video's thumbnail is removed."""
